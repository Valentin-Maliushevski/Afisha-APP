package com.itacademy.controller.filter;

import static org.apache.logging.log4j.util.Strings.isEmpty;

import com.itacademy.controller.json.utils.JwtTokenUtil;
import com.itacademy.dto.user.Role;
import com.itacademy.dto.user.User;
import com.itacademy.dto.user.UserWithoutPassword;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String url = "http://UserService:83/api/v1/users/me";
